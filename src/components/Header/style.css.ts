...
export const buttonNewPlate = styleVariants({
    primary: [buttonTextAndIcon, { border: 'none', backgroundColor: '#39B100', borderRadius: '8px', padding: '16px', color: '#FFF' }],
    error: [buttonTextAndIcon, {}]
})
